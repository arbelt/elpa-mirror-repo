...
;; 
;; 2015-10-19  Stefan Monnier  <monnier@iro.umontreal.ca>
;; 
...
;; 
;; 	* packages/f90-interface-browser/f90-interface-browser.el: Don't require
;; 	CL at runtime since it's not needed.
;; 	(f90-approx-arglist-match): Remove unused var `match'.
;; 	(f90-parse-single-type-declaration): Don't use `add-to-list' on a local
;; 	var.
;; 	* packages/f90-interface-browser/f90-tests.el: Require `cl-lib'.
;; 	(test-check, test-combine-results, parse-declaration): Fix up names
;; 	accordingly.
;; 
;; 2013-08-21  Stefan Monnier  <monnier@iro.umontreal.ca>
;; 
...
;; 
;; 	git-subtree-dir: packages/f90-interface-browser git-subtree-mainline:
;; 	da0d153e1520b5af5d008412187bbcb1d686de48 git-subtree-split:
;; 	9f6f434475bb724916506dba7b780db13544def2
;; 
;; 2012-02-05  Lawrence Mitchell  <wence@gmx.li>
;; 
;; 	Add f90-interface-browser.
;; 
;; 	git-subtree-dir: packages/f90-interface-browser git-subtree-mainline:
;; 	f4293d55a968717e82aa0f09fe791bebb9f24a3c git-subtree-split:
;; 	d0029da6b2faf9af11d3e1bc3e6f1f3f69007712
;; 
